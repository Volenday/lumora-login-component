...
const App: React.FC = () => {
  ...
  const [googleClientId, setGoogleClientId] = useState("your-google-client-id");
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(e) => setEnableLocalSignIn(e.target.checked)}
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(e) => setEnableGoogleSignIn(e.target.checked)}
      ...
      >
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Slider
            ...
            onChange={(_, value) =>
              updateBranding({
                logoHeight: Array.isArray(value) ? value[0] : value,
              })
            }
            min={24}
            max={80}
    ...
    <ThemeProvider theme={theme}>
      ...
      <Box sx={{ p: { xs: 0, sm: 3 } }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "center" }}>
          <Box sx={{ maxWidth: { xs: "100%", sm: 500 }, width: "100%" }}>
            <LumoraLogin
